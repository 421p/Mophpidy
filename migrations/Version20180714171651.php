 ...
 */
final class Version20180714171651 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE callback (id VARCHAR(255) NOT NULL COLLATE BINARY, user_id INTEGER DEFAULT NULL, parent_id VARCHAR(255) DEFAULT NULL, date DATE NOT NULL, message_id INTEGER NOT NULL, type INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_79F97426727ACA70 FOREIGN KEY (parent_id) REFERENCES callback (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_79F97426A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_79F97426727ACA70 ON callback (parent_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_79F97426727ACA70');
        $this->addSql('DROP INDEX IDX_79F97426A76ED395');
        $this->addSql('DROP INDEX callback_id_index');
        $this->addSql('CREATE TEMPORARY TABLE __temp__callback AS SELECT id, user_id, date, message_id, type FROM callback');
        $this->addSql('DROP TABLE callback');
        $this->addSql('CREATE TABLE callback (id VARCHAR(255) NOT NULL, user_id INTEGER DEFAULT NULL, date DATE NOT NULL, message_id INTEGER NOT NULL, type INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO callback (id, user_id, date, message_id, type) SELECT id, user_id, date, message_id, type FROM __temp__callback');
        $this->addSql('DROP TABLE __temp__callback');
        $this->addSql('CREATE INDEX IDX_79F97426A76ED395 ON callback (user_id)');
        $this->addSql('CREATE INDEX callback_id_index ON callback (id)');
